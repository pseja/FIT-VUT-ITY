\documentclass[twocolumn]{article}[23.02.2024]

\usepackage[a4paper, left=1.8cm, top=1.8cm, text={18.2cm, 24.1cm}]{geometry}
...
\begin{itemize}
    ...
    \item Poznámky pod čarou\footnotemark{}\footnotetext{Příliš mnoho poznámek pod čarou čtenáře zbytečně rozptyluje.} používejte opravdu střídmě. (Šetřete i~s~textem v~závorkách.)
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \emph{vlna} od pana Olšáka\footnotemark{}\footnotetext{Viz \url{http://petr.olsak.net/ftp/olsak/vlna/}}, který je vhodné si v~rámci projektu vyzkoušet.
